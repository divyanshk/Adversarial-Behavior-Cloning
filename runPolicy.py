...
with open('AAEmodels/{}/{}'.format(args.env, args.file)) as f:
    policy.load_save_dict(torch.load(f))
...
while not done:
    ...
    out, _ = policy.lstm(obs[None:].view(1, 1, -1), policy.hidden)
